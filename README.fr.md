...
- **Installation directe de l'APK** : téléchargez l'APK depuis la [release GitHub v2.27.0](https://github.com/jeiel85/markleaf-android/releases/tag/v2.27.0) ou la [release GitLab v2.27.0](https://gitlab.com/jeiel85/markleaf-android/-/releases/v2.27.0), puis exécutez-le sur votre appareil Android.
