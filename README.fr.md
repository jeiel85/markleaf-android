...
- **Installation directe de l'APK** : téléchargez l'APK depuis la [release GitHub v2.37.3](https://github.com/jeiel85/markleaf-android/releases/tag/v2.37.3), puis exécutez-le sur votre appareil Android.
