...
[**View the branding page**](https://jeiel85.github.io/markleaf-android/) · [Current version: v2.39.0](https://github.com/jeiel85/markleaf-android/releases/tag/v2.39.0) · [Privacy Policy](https://jeiel85.github.io/markleaf-android/privacy.html) · [F-Droid](https://f-droid.org/packages/com.markleaf.notes/) · [Google Play](https://play.google.com/store/apps/details?id=com.markleaf.notes)
...
- **Direct APK install**: download the APK from the [GitHub v2.39.0 release](https://github.com/jeiel85/markleaf-android/releases/tag/v2.39.0), then run it on your Android device.
