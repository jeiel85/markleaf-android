...
[**Branding-Seite ansehen**](https://jeiel85.github.io/markleaf-android/) · [Aktuelle Version: v2.26.2](https://github.com/jeiel85/markleaf-android/releases/tag/v2.26.2) · [GitLab-Release-Mirror](https://gitlab.com/jeiel85/markleaf-android/-/releases/v2.26.2) · [Datenschutzerklärung](https://jeiel85.github.io/markleaf-android/privacy.html) · [F-Droid](https://f-droid.org/packages/com.markleaf.notes/) · [Google Play](https://play.google.com/store/apps/details?id=com.markleaf.notes)
...
- **Direkte APK-Installation**: lade das APK aus dem [GitHub-v2.26.2-Release](https://github.com/jeiel85/markleaf-android/releases/tag/v2.26.2) oder dem [GitLab-v2.26.2-Release](https://gitlab.com/jeiel85/markleaf-android/-/releases/v2.26.2) herunter und führe es auf deinem Android-Gerät aus.
