...
원본 작성 기준일: 2026-05-14
원본 기준 버전: v2.14.0

상태 검토: 2026-07-28, v2.32.1. 이 문서의 P0–P2 항목은 완료 이력으로 보존한다. 현재의
우선순위는 새 상용 기능이 아니라 안정적인 최신 배포, F-Droid 반영, 반복 사용자 피드백, 그리고
지속 가능한 유지보수 비용이다. 실행 중인 운영 계획과 중단 기준은
[`docs/ROADMAP.md`](ROADMAP.md)의 **안정성, 배포, 사용자 증거** 섹션을 따른다.
