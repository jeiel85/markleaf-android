...
- **APK 직접 설치**: [GitHub v2.32.5](https://github.com/jeiel85/markleaf-android/releases/tag/v2.32.5) 릴리스에서 APK를 다운로드한 뒤 Android 기기에서 실행해 설치합니다.
