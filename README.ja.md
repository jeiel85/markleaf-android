...
[**ブランディングページを見る**](https://jeiel85.github.io/markleaf-android/) · [現在のバージョン: v2.19.0](https://github.com/jeiel85/markleaf-android/releases/tag/v2.19.0) · [プライバシーポリシー](https://jeiel85.github.io/markleaf-android/privacy.html) · [F-Droid](https://f-droid.org/packages/com.markleaf.notes/) · [Google Play](https://play.google.com/store/apps/details?id=com.markleaf.notes)
...
- **CI**: GitHub Actions — ビルド、リリース（署名済み APK + AAB）、launch-smoke、record-roborazzi
...
- **APK の直接インストール**: [v2.19.0 Release](https://github.com/jeiel85/markleaf-android/releases/tag/v2.19.0) または [Releases](https://github.com/jeiel85/markleaf-android/releases) ページから最新の APK をダウンロードし、Android 端末で実行してインストールします。
