...
[**Ver la página de branding**](https://jeiel85.github.io/markleaf-android/) · [Versión actual: v2.46.0](https://github.com/jeiel85/markleaf-android/releases/tag/v2.46.0) · [Política de privacidad](https://jeiel85.github.io/markleaf-android/privacy.html) · [F-Droid](https://f-droid.org/packages/com.markleaf.notes/) · [Google Play](https://play.google.com/store/apps/details?id=com.markleaf.notes)
...
- **Instalación directa del APK**: el [release v2.46.0 de GitHub](https://github.com/jeiel85/markleaf-android/releases/tag/v2.46.0) incluye dos APK — `markleaf-v2.46.0.apk` es la misma versión que F-Droid/Play (sin actualización automática, sin permisos adicionales), y `markleaf-v2.46.0-sideload.apk` añade una comprobación de actualización dentro de la app, opcional (`INTERNET`, `REQUEST_INSTALL_PACKAGES`). Si quieres actualizaciones dentro de la app, descarga la versión sideload y ejecútala en tu dispositivo Android — ambas usan la misma clave de firma, así que cambiar de una a otra más adelante cuenta como una actualización normal, no como una reinstalación.
