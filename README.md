...
- **Direct APK install**: download the APK from the [GitHub v2.32.3 release](https://github.com/jeiel85/markleaf-android/releases/tag/v2.32.3), then run it on your Android device.
