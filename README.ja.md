...
[**ブランディングページを見る**](https://jeiel85.github.io/markleaf-android/) · [現在のバージョン: v2.42.0](https://github.com/jeiel85/markleaf-android/releases/tag/v2.42.0) · [プライバシーポリシー](https://jeiel85.github.io/markleaf-android/privacy.html) · [F-Droid](https://f-droid.org/packages/com.markleaf.notes/) · [Google Play](https://play.google.com/store/apps/details?id=com.markleaf.notes)
...
- **APK の直接インストール**: [GitHub v2.42.0](https://github.com/jeiel85/markleaf-android/releases/tag/v2.42.0) リリースには APK が 2 つあります — `markleaf-v2.42.0.apk` は F-Droid/Play と同じビルド(自動更新なし、追加の権限なし)、`markleaf-v2.42.0-sideload.apk` はアプリ内での更新確認機能付きのビルドです(`INTERNET`、`REQUEST_INSTALL_PACKAGES` の権限が加わります)。アプリ内更新を使いたい場合は sideload 版をダウンロードして Android 端末で実行してインストールしてください — どちらも同じ署名鍵を使うため、後で入れ替えても再インストールではなく通常の更新として扱われます。
