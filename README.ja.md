...
- **APK の直接インストール**: [GitHub v2.29.1](https://github.com/jeiel85/markleaf-android/releases/tag/v2.29.1) リリースから APK をダウンロードし、Android 端末で実行してインストールします。
