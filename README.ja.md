...
[**ブランディングページを見る**](https://jeiel85.github.io/markleaf-android/) · [現在のバージョン: v2.32.6](https://github.com/jeiel85/markleaf-android/releases/tag/v2.32.6) · [プライバシーポリシー](https://jeiel85.github.io/markleaf-android/privacy.html) · [F-Droid](https://f-droid.org/packages/com.markleaf.notes/) · [Google Play](https://play.google.com/store/apps/details?id=com.markleaf.notes)
...
- **7 言語 UI** — 韓国語 / 英語 / スペイン語 / 日本語 / フランス語 / ドイツ語 / 簡体字中国語のリソースを運用
...
- **APK の直接インストール**: [GitHub v2.32.6](https://github.com/jeiel85/markleaf-android/releases/tag/v2.32.6) リリースから APK をダウンロードし、Android 端末で実行してインストールします。
