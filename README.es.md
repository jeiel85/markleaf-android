...
- **Instalación directa del APK**: descarga el APK desde el [release v2.27.0 de GitHub](https://github.com/jeiel85/markleaf-android/releases/tag/v2.27.0) o el [release v2.27.0 de GitLab](https://gitlab.com/jeiel85/markleaf-android/-/releases/v2.27.0), y ejecútalo en tu dispositivo Android.
