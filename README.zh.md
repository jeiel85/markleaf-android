...
[**查看品牌页面**](https://jeiel85.github.io/markleaf-android/index.zh.html) · [当前版本：v2.37.1](https://github.com/jeiel85/markleaf-android/releases/tag/v2.37.1) · [隐私政策](https://jeiel85.github.io/markleaf-android/privacy.zh.html) · [F-Droid](https://f-droid.org/packages/com.markleaf.notes/) · [Google Play](https://play.google.com/store/apps/details?id=com.markleaf.notes)
...
- **直接安装 APK**：从 [GitHub v2.37.1 发布页](https://github.com/jeiel85/markleaf-android/releases/tag/v2.37.1) 下载 APK，然后在你的 Android 设备上运行。
