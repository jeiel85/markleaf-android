...
- **Installation directe de l'APK** : téléchargez l'APK depuis la [release GitHub v2.31.0](https://github.com/jeiel85/markleaf-android/releases/tag/v2.31.0), puis exécutez-le sur votre appareil Android.
