...
[**View the branding page**](https://jeiel85.github.io/markleaf-android/) · [Current version: v2.51.0](https://github.com/jeiel85/markleaf-android/releases/tag/v2.51.0) · [Privacy Policy](https://jeiel85.github.io/markleaf-android/privacy.html) · [F-Droid](https://f-droid.org/packages/com.markleaf.notes/) · [Google Play](https://play.google.com/store/apps/details?id=com.markleaf.notes)
...
- **Direct APK install**: the [GitHub v2.51.0 release](https://github.com/jeiel85/markleaf-android/releases/tag/v2.51.0) carries two APKs — `markleaf-v2.51.0.apk` matches the F-Droid/Play build (no auto-update, no extra permission), and `markleaf-v2.51.0-sideload.apk` adds an opt-in in-app update check (`INTERNET`, `REQUEST_INSTALL_PACKAGES`). Pick the sideload one for in-app updates, download it, then run it on your Android device — both share the same signing key, so switching between them later is a normal update, not a reinstall.
