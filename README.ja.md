...
<p align="center">
  ...
  <a href="https://gitlab.com/jeiel85/markleaf-android">GitLab ミラー（アーカイブ）</a>
</p>
...
[**ブランディングページを見る**](https://jeiel85.github.io/markleaf-android/) · [現在のバージョン: v2.53.2](https://github.com/jeiel85/markleaf-android/releases/tag/v2.53.2) · [プライバシーポリシー](https://jeiel85.github.io/markleaf-android/privacy.html) · [F-Droid](https://f-droid.org/packages/com.markleaf.notes/) · [Google Play](https://play.google.com/store/apps/details?id=com.markleaf.notes)
...
- **11 言語 UI** — 韓国語 / 英語 / スペイン語 / 日本語 / フランス語 / ドイツ語 / 簡体字中国語 / クロアチア語 / ロシア語 / ベトナム語 / スロバキア語のリソースを運用
...
- **Markdown パーサー**: [commonmark-java](https://github.com/commonmark/commonmark-java)（CommonMark 0.30 + GFM 拡張: テーブル、取り消し線、task lists、脚注、YAML frontmatter、プレビューは単一の改行を空白ではなく改行として表示）
...
- **CI**: GitHub Actions — build と instrumented tests が必須チェック、加えて launch-smoke、record-roborazzi、タグ時の署名済みリリース
...
- **APK の直接インストール**: [GitHub v2.53.2](https://github.com/jeiel85/markleaf-android/releases/tag/v2.53.2) リリースには APK が 2 つあります — `markleaf-v2.53.2.apk` は F-Droid/Play と同じビルド(自動更新なし、追加の権限なし)、`markleaf-v2.53.2-sideload.apk` はアプリ内での更新確認機能付きのビルドです(`INTERNET`、`REQUEST_INSTALL_PACKAGES` の権限が加わります)。アプリ内更新を使いたい場合は sideload 版をダウンロードして Android 端末で実行してインストールしてください — どちらも同じ署名鍵を使うため、後で入れ替えても再インストールではなく通常の更新として扱われます。
