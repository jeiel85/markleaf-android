...
[**Branding-Seite ansehen**](https://jeiel85.github.io/markleaf-android/) · [Aktuelle Version: v2.30.0](https://github.com/jeiel85/markleaf-android/releases/tag/v2.30.0) · [Datenschutzerklärung](https://jeiel85.github.io/markleaf-android/privacy.html) · [F-Droid](https://f-droid.org/packages/com.markleaf.notes/) · [Google Play](https://play.google.com/store/apps/details?id=com.markleaf.notes)
...
- **Direkte APK-Installation**: lade das APK aus dem [GitHub-v2.30.0-Release](https://github.com/jeiel85/markleaf-android/releases/tag/v2.30.0) herunter und führe es auf deinem Android-Gerät aus.
