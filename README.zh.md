...
[**查看品牌页面**](https://jeiel85.github.io/markleaf-android/index.zh.html) · [当前版本：v2.32.4](https://github.com/jeiel85/markleaf-android/releases/tag/v2.32.4) · [隐私政策](https://jeiel85.github.io/markleaf-android/privacy.zh.html) · [F-Droid](https://f-droid.org/packages/com.markleaf.notes/) · [Google Play](https://play.google.com/store/apps/details?id=com.markleaf.notes)
...
- **导入外部 `.md` / `.txt` 文件** — 在文件管理器中点击文件，或从其他应用分享过来，即可作为新笔记导入（没有标题时用文件名作为标题）。同步进来的笔记中的标签会被立即识别
- **将单篇 / 全部笔记导出为 `.md`**
- **通过系统分享面板发送**
...
- **7 种语言界面** — 韩语 / 英语 / 西班牙语 / 日语 / 法语 / 德语 / 简体中文资源
...
- **直接安装 APK**：从 [GitHub v2.32.4 发布页](https://github.com/jeiel85/markleaf-android/releases/tag/v2.32.4) 下载 APK，然后在你的 Android 设备上运行。
