...
[**Ver la página de branding**](https://jeiel85.github.io/markleaf-android/) · [Versión actual: v2.38.0](https://github.com/jeiel85/markleaf-android/releases/tag/v2.38.0) · [Política de privacidad](https://jeiel85.github.io/markleaf-android/privacy.html) · [F-Droid](https://f-droid.org/packages/com.markleaf.notes/) · [Google Play](https://play.google.com/store/apps/details?id=com.markleaf.notes)
...
- **Instalación directa del APK**: descarga el APK desde el [release v2.38.0 de GitHub](https://github.com/jeiel85/markleaf-android/releases/tag/v2.38.0), y ejecútalo en tu dispositivo Android.
