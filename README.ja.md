...
[**ブランディングページを見る**](https://jeiel85.github.io/markleaf-android/) · [現在のバージョン: v2.30.0](https://github.com/jeiel85/markleaf-android/releases/tag/v2.30.0) · [プライバシーポリシー](https://jeiel85.github.io/markleaf-android/privacy.html) · [F-Droid](https://f-droid.org/packages/com.markleaf.notes/) · [Google Play](https://play.google.com/store/apps/details?id=com.markleaf.notes)
...
- **APK の直接インストール**: [GitHub v2.30.0](https://github.com/jeiel85/markleaf-android/releases/tag/v2.30.0) リリースから APK をダウンロードし、Android 端末で実行してインストールします。
