...
[**Pogledajte stranicu projekta**](https://jeiel85.github.io/markleaf-android/) · [Trenutačna verzija: v2.50.0](https://github.com/jeiel85/markleaf-android/releases/tag/v2.50.0) · [Pravila privatnosti](https://jeiel85.github.io/markleaf-android/privacy.html) · [F-Droid](https://f-droid.org/packages/com.markleaf.notes/) · [Google Play](https://play.google.com/store/apps/details?id=com.markleaf.notes)
...
- **Izravna instalacija APK-a**: [GitHub izdanje v2.50.0](https://github.com/jeiel85/markleaf-android/releases/tag/v2.50.0) sadrži dva APK-a — `markleaf-v2.50.0.apk` odgovara F-Droid/Play inačici (bez automatskog ažuriranja, bez dodatnih dopuštenja), a `markleaf-v2.50.0-sideload.apk` dodaje neobavezno ažuriranje unutar aplikacije (dopuštenja `INTERNET` i `REQUEST_INSTALL_PACKAGES`). Za ažuriranje unutar aplikacije preuzmite sideload inačicu i pokrenite je na svom Android uređaju — obje koriste isti ključ za potpisivanje, pa je kasnija zamjena jedne drugom obično ažuriranje, a ne ponovna instalacija.
