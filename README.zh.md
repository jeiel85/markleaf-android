...
[**查看品牌页面**](https://jeiel85.github.io/markleaf-android/index.zh.html) · [当前版本：v2.48.0](https://github.com/jeiel85/markleaf-android/releases/tag/v2.48.0) · [隐私政策](https://jeiel85.github.io/markleaf-android/privacy.zh.html) · [F-Droid](https://f-droid.org/packages/com.markleaf.notes/) · [Google Play](https://play.google.com/store/apps/details?id=com.markleaf.notes)
...
- **直接安装 APK**：[GitHub v2.48.0 发布页](https://github.com/jeiel85/markleaf-android/releases/tag/v2.48.0) 附带两个 APK——`markleaf-v2.48.0.apk` 与 F-Droid/Play 上的版本相同（无自动更新、无额外权限），`markleaf-v2.48.0-sideload.apk` 则开启了应用内更新检查（新增 `INTERNET` 和 `REQUEST_INSTALL_PACKAGES` 权限）。想要应用内更新就下载 sideload 版，然后在你的 Android 设备上运行安装——两者使用相同的签名密钥，之后互相切换会被当作正常更新，而不是重新安装。
