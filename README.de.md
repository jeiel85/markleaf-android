...
[**Branding-Seite ansehen**](https://jeiel85.github.io/markleaf-android/) · [Aktuelle Version: v2.41.0](https://github.com/jeiel85/markleaf-android/releases/tag/v2.41.0) · [Datenschutzerklärung](https://jeiel85.github.io/markleaf-android/privacy.html) · [F-Droid](https://f-droid.org/packages/com.markleaf.notes/) · [Google Play](https://play.google.com/store/apps/details?id=com.markleaf.notes)
...
- **Direkte APK-Installation**: lade das APK aus dem [GitHub-v2.41.0-Release](https://github.com/jeiel85/markleaf-android/releases/tag/v2.41.0) herunter und führe es auf deinem Android-Gerät aus.
...
**Eine einzige Ausnahme.** Das APK auf [GitHub Releases](https://github.com/jeiel85/markleaf-android/releases/latest) deklariert `INTERNET` – für genau eine Sache: eine **standardmäßig ausgeschaltete, ausdrücklich zu aktivierende** Update-Prüfung, die eine einzige statische JSON-Datei liest. Die Builds für F-Droid und Google Play enthalten weder diese Berechtigung noch diesen Code – nicht deaktiviert, sondern **gar nicht vorhanden**. **In keinem Build werden Notizen, Tags, Anhänge, Metadaten, Kennungen oder Nutzungsdaten gesendet.** Die Grenze ist in [`docs/AGENT_SPEC.md` §15.9](docs/AGENT_SPEC.md) festgehalten.
