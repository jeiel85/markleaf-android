...
- [x] **No INTERNET Permission**: The artefact distributed through F-Droid and Google Play does
      not declare `android.permission.INTERNET` in its manifest. A sideload-only build, produced
