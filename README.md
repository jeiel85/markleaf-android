...
- **Direct APK install**: download the APK from the [GitHub v2.27.0 release](https://github.com/jeiel85/markleaf-android/releases/tag/v2.27.0) or the [GitLab v2.27.0 release](https://gitlab.com/jeiel85/markleaf-android/-/releases/v2.27.0), then run it on your Android device.
