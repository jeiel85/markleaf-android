...
- **APK の直接インストール**: [GitHub v2.28.1](https://github.com/jeiel85/markleaf-android/releases/tag/v2.28.1) または [GitLab v2.28.1](https://gitlab.com/jeiel85/markleaf-android/-/releases/v2.28.1) リリースから APK をダウンロードし、Android 端末で実行してインストールします。
