...
[**브랜딩 페이지 보기**](https://jeiel85.github.io/markleaf-android/) · [현재 버전: v2.27.1](https://github.com/jeiel85/markleaf-android/releases/tag/v2.27.1) · [GitLab 릴리스 미러](https://gitlab.com/jeiel85/markleaf-android/-/releases/v2.27.1) · [Privacy Policy](https://jeiel85.github.io/markleaf-android/privacy.html) · [F-Droid](https://f-droid.org/packages/com.markleaf.notes/) · [Google Play](https://play.google.com/store/apps/details?id=com.markleaf.notes)
...
- **APK 직접 설치**: [GitHub v2.27.1](https://github.com/jeiel85/markleaf-android/releases/tag/v2.27.1) 또는 [GitLab v2.27.1](https://gitlab.com/jeiel85/markleaf-android/-/releases/v2.27.1) 릴리스에서 APK를 다운로드한 뒤 Android 기기에서 실행해 설치합니다.
