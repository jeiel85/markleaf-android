...
- **Instalación directa del APK**: descarga el APK desde el [release v2.28.1 de GitHub](https://github.com/jeiel85/markleaf-android/releases/tag/v2.28.1), y ejecútalo en tu dispositivo Android.
