...
- **Installation directe de l'APK** : téléchargez l'APK depuis la [release GitHub v2.28.1](https://github.com/jeiel85/markleaf-android/releases/tag/v2.28.1), puis exécutez-le sur votre appareil Android.
