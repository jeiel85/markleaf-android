...
- **APK の直接インストール**: [v2.18.1 Release](https://github.com/jeiel85/markleaf-android/releases/tag/v2.18.1) または [Releases](https://github.com/jeiel85/markleaf-android/releases) ページから最新の APK をダウンロードし、Android 端末で実行してインストールします。
