...
- **直接安装 APK**：从 [GitHub v2.32.2 发布页](https://github.com/jeiel85/markleaf-android/releases/tag/v2.32.2) 下载 APK，然后在你的 Android 设备上运行。
