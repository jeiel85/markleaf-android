...
[**Voir la page de branding**](https://jeiel85.github.io/markleaf-android/) · [Version actuelle : v2.46.2](https://github.com/jeiel85/markleaf-android/releases/tag/v2.46.2) · [Politique de confidentialité](https://jeiel85.github.io/markleaf-android/privacy.html) · [F-Droid](https://f-droid.org/packages/com.markleaf.notes/) · [Google Play](https://play.google.com/store/apps/details?id=com.markleaf.notes)
...
- **Installation directe de l'APK** : la [release GitHub v2.46.2](https://github.com/jeiel85/markleaf-android/releases/tag/v2.46.2) contient deux APK — `markleaf-v2.46.2.apk` correspond à la version F-Droid/Play (pas de mise à jour automatique, aucune permission supplémentaire), et `markleaf-v2.46.2-sideload.apk` ajoute une vérification de mise à jour intégrée à l'application, activable (`INTERNET`, `REQUEST_INSTALL_PACKAGES`). Pour les mises à jour intégrées, choisissez la version sideload, téléchargez-la, puis exécutez-la sur votre appareil Android — les deux partagent la même clé de signature, donc passer de l'une à l'autre plus tard compte comme une mise à jour normale, pas comme une réinstallation.
