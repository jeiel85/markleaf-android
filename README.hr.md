...
[**Pogledajte stranicu projekta**](https://jeiel85.github.io/markleaf-android/) · [Trenutačna verzija: v2.53.2](https://github.com/jeiel85/markleaf-android/releases/tag/v2.53.2) · [Pravila privatnosti](https://jeiel85.github.io/markleaf-android/privacy.html) · [F-Droid](https://f-droid.org/packages/com.markleaf.notes/) · [Google Play](https://play.google.com/store/apps/details?id=com.markleaf.notes)
...
- **Sučelje na 11 jezika** — hrvatski / korejski / engleski / španjolski / japanski / francuski / njemački / kineski (pojednostavljeni) / ruski / vijetnamski / slovački
...
- **Izravna instalacija APK-a**: [GitHub izdanje v2.53.2](https://github.com/jeiel85/markleaf-android/releases/tag/v2.53.2) sadrži dva APK-a — `markleaf-v2.53.2.apk` odgovara F-Droid/Play inačici (bez automatskog ažuriranja, bez dodatnih dopuštenja), a `markleaf-v2.53.2-sideload.apk` dodaje neobavezno ažuriranje unutar aplikacije (dopuštenja `INTERNET` i `REQUEST_INSTALL_PACKAGES`). Za ažuriranje unutar aplikacije preuzmite sideload inačicu i pokrenite je na svom Android uređaju — obje koriste isti ključ za potpisivanje, pa je kasnija zamjena jedne drugom obično ažuriranje, a ne ponovna instalacija.
