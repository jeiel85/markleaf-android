...
foreach ($loc in 'ko-KR','en-US','ja-JP','zh-CN','de-DE','fr-FR','es-ES','hr-HR','ru-RU','vi-VN','sk-SK') {
...
The landing page ships in eleven languages: `docs/index.html` (English, the
canonical / x-default), `docs/index.ko.html`, `docs/index.ja.html`,
`docs/index.zh.html`, `docs/index.de.html`, `docs/index.es.html`,
`docs/index.fr.html`, `docs/index.hr.html`, `docs/index.ru.html`,
`docs/index.vi.html`, and `docs/index.sk.html`. The "current release" version
appears in three places per file — the JSON-LD `softwareVersion`, the hero
`release-line`, and the trust-ledger `<strong>`.

The eleven READMEs are checked as well. There the target is any line carrying a
...
The privacy pages (`docs/privacy*.html`) ship in the same eleven languages and
