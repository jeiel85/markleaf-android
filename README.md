...
[**View the branding page**](https://jeiel85.github.io/markleaf-android/) · [Current version: v2.28.1](https://github.com/jeiel85/markleaf-android/releases/tag/v2.28.1) · [GitLab release mirror](https://gitlab.com/jeiel85/markleaf-android/-/releases/v2.28.1) · [Privacy Policy](https://jeiel85.github.io/markleaf-android/privacy.html) · [F-Droid](https://f-droid.org/packages/com.markleaf.notes/) · [Google Play](https://play.google.com/store/apps/details?id=com.markleaf.notes)
...
- **Direct APK install**: download the APK from the [GitHub v2.28.1 release](https://github.com/jeiel85/markleaf-android/releases/tag/v2.28.1) or the [GitLab v2.28.1 release](https://gitlab.com/jeiel85/markleaf-android/-/releases/v2.28.1), then run it on your Android device.
