...
- **Instalación directa del APK**: descarga el APK desde el [release v2.31.0 de GitHub](https://github.com/jeiel85/markleaf-android/releases/tag/v2.31.0), y ejecútalo en tu dispositivo Android.
