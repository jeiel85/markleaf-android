...
- **Direct APK install**: download the APK from the [GitHub v2.37.0 release](https://github.com/jeiel85/markleaf-android/releases/tag/v2.37.0), then run it on your Android device.
